...
class MostCasesPanel extends StatelessWidget {
  ...
  const MostCasesPanel({Key key, this.countryData}) : super(key: key);
          ...
          return Container(
            ...
            child: Row(
                children: [
                  ...
                  SizedBox(width: 10,),
                  Text('Cases:' + '   ' + countryData[index]['cases'].toString(), style: TextStyle(color: primaryBlack, fontWeight: FontWeight.w900),),
