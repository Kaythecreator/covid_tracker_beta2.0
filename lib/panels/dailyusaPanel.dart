...
class DailyusaPanel extends StatelessWidget {

  final Map dailyusaData;

  const DailyusaPanel({Key key, this.dailyusaData}) : super(key: key);
      ...
      child: GridView(
        ...
        children: [
          StatusPanel(
            ...
            count: dailyusaData['todayCases'].toString(),
          ),
          StatusPanel(
            title: 'TOTAL ACTIVE',
            ...
            textColor: Colors.white,
            count: dailyusaData['active'].toString(),
          ),
          StatusPanel(
            title: 'RECOVERED',
            ...
            textColor: Colors.white,
            count: dailyusaData['todayRecovered'].toString(),
          ),
          StatusPanel(
            title: 'DEATHS',
            ...
            textColor: Colors.white,
            count: dailyusaData['todayDeaths'].toString(),
          ),
        ],
      ),
    );
